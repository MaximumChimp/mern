import VcImg from  "../assets/video_call.svg";
import OlFriends from "../assets/online_friends_2.svg";
           ...
           <div className="container">
                <div className="row" id="Title">
                    <div className="item-cont">
                        <h1><b>Made by Student , 
                            Built for Students</b></h1>
                        <div className="items">
                            <p className="OnlineCont"> <FaCircle  id="onlineIcon"/>235 Online</p>
                ...
                <div className="row" id="VcContainer">
                    <div className="col" id="Vc-Cont">
                        <h1>High Quality Video Call</h1>
